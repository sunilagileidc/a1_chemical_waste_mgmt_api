...
return new class extends Migration
{
    ...
    {
        Schema::create('prescriber_medication', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('primary key');
            $table->unsignedBigInteger('prescriber_id')->comment('Foreign key referencing prescriber_details table');
