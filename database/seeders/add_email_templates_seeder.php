    ...
    public function run()
    {
        ...
        DB::table('email_templates')->insert([
            ...
            [
                ...
                'template_signature' => '<p>Regards,<br />Pharmacare Group</p>',
                'can_override'       => 'N',
                'slug'               => 'forgot-pass',
                'template_type_id'   => $parentid,
            ],
            [
                ...
                'template_body'      => '<p style=\"text-align:left\">Hi {{firstname}}, <br/> Welcome to Pharmacare Group.  We have created an account and the username is the registered email and the password is {{password}}</p>',
                'template_signature' => '<br/><p>Regards,<br />Pharmacare Group</p>',
                'can_override'       => 'N',
